...
async function connectToWA() {
  ...
  console.log("Connecting 🧚‍♂️𝗗𝗔𝗚𝗔𝗬𝗔-𝗠𝗗✨");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("🧚‍♂️𝗗𝗔𝗚𝗔𝗬𝗔-𝗠𝗗✨ installed successful ✅");
      console.log("🧚‍♂️𝗗𝗔𝗚𝗔𝗬𝗔-𝗠𝗗✨ connected to whatsapp ✅");

      let up = `🧚‍♂️𝗗𝗔𝗚𝗔𝗬𝗔-𝗠𝗗✨ connected successful ✅`;
      let up1 = `Hello Dagaya, I made bot successful`;
      ...
      robin.sendMessage("94703995359@s.whatsapp.net", {
        image: {
          url: `https://raw.githubusercontent.com/dagaya254/Bot-4to/refs/heads/main/20250303_055414.jpg`,
        },
        caption: up1,
...
app.get("/", (req, res) => {
  res.send("hey, 🧚‍♂️𝗗𝗔𝗚𝗔𝗬𝗔-𝗠𝗗✨ started✅");
});
app.listen(port, () =>
